...
parser.add_argument('--width', type=int, default=300,
                    help="input width of the model to be exported (in pixels)")
parser.add_argument('--height', type=int, default=300,
                    help="input height of the model to be exported (in pixels)")
...
args = parser.parse_args(fake_arg)
print(args)
    ...
    if not args.input:
        ...
        for file in os.listdir(args.model_dir):
            ...
            try:
                ...
                continue
        print('found best checkpoint with loss {:f} ({:s})'.format(
            best_loss, args.input))
